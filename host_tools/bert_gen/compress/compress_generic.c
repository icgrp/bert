...
#define FRAMES_PER_BRAM SERIES7_FRAMES_PER_BRAM
  int bram18_starts[SERIES7_BRAM18_STARTS_PER_FRAME+1]=SERIES7_BRAM18_STARTS;
#endif
...
#define FRAMES_PER_BRAM ULTRASCALE_FRAMES_PER_BRAM
...
int main ()
{
  ...
  printf("int bitlocation[%d]=%s;\n",SERIES7_WE_BITS_PER_FRAME,SERIES7_BITLOCATION);
  ...
  printf("int bitlocation[%d]=%s;\n",ULTRASCALE_WE_BITS_PER_FRAME,ULTRASCALE_BITLOCATION);
