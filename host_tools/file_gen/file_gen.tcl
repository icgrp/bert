...
proc file_gen { dirName } {
    ...
    write_hwdef  -force $dirName/top.hdf
    puts "##############################"
    ...
    puts "You can move on by changing to your .../bert/host_tools/bert_gen directory and then executing './gen.sh -gen $dirName/top.dcp mydesign'"
}
