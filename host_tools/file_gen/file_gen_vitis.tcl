...
proc file_gen { dirName } {
    ...
    puts "You can move on by changing tobert/host_tools/file_gen/file_gen_TOOL.tcl your .../bert/host_tools/bert_gen directory and then executing './gen.sh -gen $dirName'"
}
