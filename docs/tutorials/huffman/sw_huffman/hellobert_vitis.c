...
int main()
{
    ...
    int mem_hist_slot = logical_memory_slot("design_1_i/top_0/inst/HUFFMAN/ENCODER/HIST/inst/HUFFMAN/ENCODER/HIST/histMem", NUM_LOGICAL);
    int mem_result_slot = logical_memory_slot("design_1_i/top_0/inst/HUFFMAN/CONSUMER/inst/HUFFMAN/CONSUMER/resultsMem", NUM_LOGICAL);
