...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set huffClr_0 [ create_bd_port -dir O huffClr_0 ]

  # Create instance: axi_bram_ctrl_hist, and set properties
  set axi_bram_ctrl_hist [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_hist ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_hist

  # Create instance: axi_bram_ctrl_huff, and set properties
  set axi_bram_ctrl_huff [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_huff ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_huff

  # Create instance: axi_bram_ctrl_raw, and set properties
  set axi_bram_ctrl_raw [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_raw ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_raw

  # Create instance: axi_bram_ctrl_results, and set properties
  set axi_bram_ctrl_results [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_results ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_results
  ...
  # Create instance: reg4_0, and set properties
  set reg4_0 [ create_bd_cell -type ip -vlnv user.org:user:reg4:1.0 reg4_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins reg4_0/S00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axi_bram_ctrl_raw/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins axi_bram_ctrl_hist/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axi_bram_ctrl_huff/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins axi_bram_ctrl_results/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net axi_bram_ctrl_hist_bram_addr_a [get_bd_pins axi_bram_ctrl_hist/bram_addr_a] [get_bd_pins top_0/psHistAddr]
  connect_bd_net -net axi_bram_ctrl_huff_bram_addr_a [get_bd_pins axi_bram_ctrl_huff/bram_addr_a] [get_bd_pins top_0/psHuffAddr]
  connect_bd_net -net axi_bram_ctrl_huff_bram_en_a [get_bd_pins axi_bram_ctrl_huff/bram_en_a] [get_bd_pins top_0/psHuffEna]
  connect_bd_net -net axi_bram_ctrl_huff_bram_we_a [get_bd_pins axi_bram_ctrl_huff/bram_we_a] [get_bd_pins top_0/psHuffWE]
  connect_bd_net -net axi_bram_ctrl_huff_bram_wrdata_a [get_bd_pins axi_bram_ctrl_huff/bram_wrdata_a] [get_bd_pins top_0/psHuffDin]
  connect_bd_net -net axi_bram_ctrl_raw_bram_addr_a [get_bd_pins axi_bram_ctrl_raw/bram_addr_a] [get_bd_pins top_0/psRawAddr]
  connect_bd_net -net axi_bram_ctrl_raw_bram_clk_a [get_bd_pins axi_bram_ctrl_raw/bram_clk_a] [get_bd_pins top_0/clk]
  connect_bd_net -net axi_bram_ctrl_raw_bram_en_a [get_bd_pins axi_bram_ctrl_raw/bram_en_a] [get_bd_pins top_0/psRawEna]
  connect_bd_net -net axi_bram_ctrl_raw_bram_we_a [get_bd_pins axi_bram_ctrl_raw/bram_we_a] [get_bd_pins top_0/psRawWE]
  connect_bd_net -net axi_bram_ctrl_raw_bram_wrdata_a [get_bd_pins axi_bram_ctrl_raw/bram_wrdata_a] [get_bd_pins top_0/psRawDin]
  connect_bd_net -net axi_bram_ctrl_results_bram_addr_a [get_bd_pins axi_bram_ctrl_results/bram_addr_a] [get_bd_pins top_0/psResultsAddr]
  connect_bd_net -net reg4_0_huffClr [get_bd_pins reg4_0/huffClr] [get_bd_pins top_0/clr]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_hist/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_huff/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_raw/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_results/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins reg4_0/s00_axi_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net top_0_done [get_bd_pins reg4_0/huffDone] [get_bd_pins top_0/done]
  connect_bd_net -net top_0_psHistDout [get_bd_pins axi_bram_ctrl_hist/bram_rddata_a] [get_bd_pins top_0/psHistDout]
  connect_bd_net -net top_0_psResultsDout [get_bd_pins axi_bram_ctrl_results/bram_rddata_a] [get_bd_pins top_0/psResultsDout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_hist/s_axi_aclk] [get_bd_pins axi_bram_ctrl_huff/s_axi_aclk] [get_bd_pins axi_bram_ctrl_raw/s_axi_aclk] [get_bd_pins axi_bram_ctrl_results/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins reg4_0/s00_axi_aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_raw/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_hist/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0003000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_huff/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_results/S_AXI/Mem0] SEG_axi_bram_ctrl_3_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs reg4_0/S00_AXI/S00_AXI_reg] SEG_reg4_0_S00_AXI_reg
