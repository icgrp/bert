...
const char *logical_names[] = {"design_1_i/top_0/inst/HUFFMAN/ENCODER/inst/HUFFMAN/ENCODER/huffmanMem","design_1_i/top_0/inst/HUFFMAN/PRODUCER/inst/HUFFMAN/PRODUCER/rawTextMem","design_1_i/top_0/inst/HUFFMAN/CONSUMER/resultsMem","design_1_i/top_0/inst/HUFFMAN/ENCODER/HIST/histMem"};
// Beginning of Logical Memory 0
#define MEM0SEG0BITS_IN_FRAME0 40
int mem0seg0frame0bits[40]={720,732,744,756,780,792,804,816,726,738,750,762,786,798,810,822,723,735,747,759,722,734,746,758,782,794,806,818,728,740,752,764,788,800,812,824,725,737,749,761};
#define MEM0SEG0FRAME0 {MEM0SEG0BITS_IN_FRAME0,0x1040100,mem0seg0frame0bits}
//MEM0SEG0 repeat distance 40 covering 1 frames
#define MEM0SEG0FRAMES_IN_REPEAT 1
#define MEM0SEG0BITS_IN_REPEAT 40
...
#define MEM3FR0WEBITS (0x400)
// End of Logical Memory 3
struct frame_range mem0_frame_ranges[1] = {{0x1040100,256,MEM0FR0WEBITS,1} };
...
struct frame_range mem3_frame_ranges[1] = {{0x10401c0,64,MEM3FR0WEBITS,0} };
struct logical_memory logical_memories[NUM_LOGICAL] ={
	{1,20,512,MEM0SEGMENTS,mem0_frame_ranges,mem0repeats}
,	{1,8,1024,MEM1SEGMENTS,mem1_frame_ranges,mem1repeats}
,	{1,16,1024,MEM2SEGMENTS,mem2_frame_ranges,mem2repeats}
,	{1,16,256,MEM3SEGMENTS,mem3_frame_ranges,mem3repeats}
};
